...
main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window.handle))
	{
		...
		shader_uniform_vec3(cube_shader, "u_dirlight.ambient", dirlight_ambient);
		shader_uniform_vec3(cube_shader, "u_dirlight.diffuse", dirlight_diffuse);
		shader_uniform_vec3(cube_shader, "u_dirlight.specular", dirlight_specular);

		// point light 1
		shader_uniform_vec3(cube_shader, "u_pointlights[0].position", pointlight_positions[0]);
		shader_uniform_vec3(cube_shader, "u_pointlights[0].ambient", (vec3){ pointlight_colors[0][0] * 0.1f, pointlight_colors[0][1] * 0.1f, pointlight_colors[0][2] * 0.1f });
		shader_uniform_vec3(cube_shader, "u_pointlights[0].diffuse", (vec3){ pointlight_colors[0][0], pointlight_colors[0][1], pointlight_colors[0][2] });
		shader_uniform_vec3(cube_shader, "u_pointlights[0].specular", (vec3){ pointlight_colors[0][0], pointlight_colors[0][1], pointlight_colors[0][2] });
		shader_uniform_float(cube_shader, "u_pointlights[0].constant", pointlight_constant);
		shader_uniform_float(cube_shader, "u_pointlights[0].linear", pointlight_linear);
		shader_uniform_float(cube_shader, "u_pointlights[0].quadratic", pointlight_quadratic);

		// point light 2
		shader_uniform_vec3(cube_shader, "u_pointlights[1].position", pointlight_positions[1]);
		shader_uniform_vec3(cube_shader, "u_pointlights[1].ambient", (vec3){ pointlight_colors[1][0] * 0.1f, pointlight_colors[1][1] * 0.1f, pointlight_colors[1][2] * 0.1f });
		shader_uniform_vec3(cube_shader, "u_pointlights[1].diffuse", (vec3){ pointlight_colors[1][0], pointlight_colors[1][1], pointlight_colors[1][2] });
		shader_uniform_vec3(cube_shader, "u_pointlights[1].specular", (vec3){ pointlight_colors[1][0], pointlight_colors[1][1], pointlight_colors[1][2] });
		shader_uniform_float(cube_shader, "u_pointlights[1].constant", pointlight_constant);
		shader_uniform_float(cube_shader, "u_pointlights[1].linear", pointlight_linear);
		shader_uniform_float(cube_shader, "u_pointlights[1].quadratic", pointlight_quadratic);

		// point light 3
		shader_uniform_vec3(cube_shader, "u_pointlights[2].position", pointlight_positions[2]);
		shader_uniform_vec3(cube_shader, "u_pointlights[2].ambient", (vec3){ pointlight_colors[2][0] * 0.1f, pointlight_colors[2][1] * 0.1f, pointlight_colors[2][2] * 0.1f });
		shader_uniform_vec3(cube_shader, "u_pointlights[2].diffuse", (vec3){ pointlight_colors[2][0], pointlight_colors[2][1], pointlight_colors[2][2] });
		shader_uniform_vec3(cube_shader, "u_pointlights[2].specular", (vec3){ pointlight_colors[2][0], pointlight_colors[2][1], pointlight_colors[2][2] });
		shader_uniform_float(cube_shader, "u_pointlights[2].constant", pointlight_constant);
		shader_uniform_float(cube_shader, "u_pointlights[2].linear", pointlight_linear);
		shader_uniform_float(cube_shader, "u_pointlights[2].quadratic", pointlight_quadratic);

		// point light 1
		shader_uniform_vec3(cube_shader, "u_pointlights[3].position", pointlight_positions[3]);
		shader_uniform_vec3(cube_shader, "u_pointlights[3].ambient", (vec3){ pointlight_colors[3][0] * 0.1f, pointlight_colors[3][1] * 0.1f, pointlight_colors[3][2] * 0.1f });
		shader_uniform_vec3(cube_shader, "u_pointlights[3].diffuse", (vec3){ pointlight_colors[3][0], pointlight_colors[3][1], pointlight_colors[3][2] });
		shader_uniform_vec3(cube_shader, "u_pointlights[3].specular", (vec3){ pointlight_colors[3][0], pointlight_colors[3][1], pointlight_colors[3][2] });
		shader_uniform_float(cube_shader, "u_pointlights[3].constant", pointlight_constant);
		shader_uniform_float(cube_shader, "u_pointlights[3].linear", pointlight_linear);
		shader_uniform_float(cube_shader, "u_pointlights[3].quadratic", pointlight_quadratic);
		...
		shader_uniform_vec3(cube_shader, "u_spotlight.ambient", spotlight_ambient);
		shader_uniform_vec3(cube_shader, "u_spotlight.diffuse", spotlight_diffuse);
		shader_uniform_vec3(cube_shader, "u_spotlight.specular", spotlight_specular);
		shader_uniform_float(cube_shader, "u_spotlight.constant", spotlight_constant);
		shader_uniform_float(cube_shader, "u_spotlight.linear", spotlight_linear);
		shader_uniform_float(cube_shader, "u_spotlight.quadratic", spotlight_quadratic);
		shader_uniform_float(cube_shader, "u_spotlight.cutoff", cos(glm_rad(spotlight_cutoff)));
		shader_uniform_float(cube_shader, "u_spotlight.cutoff_outer", cos(glm_rad(spotlight_cutoff_outer)));
		...
		for (unsigned int i = 0; i < 4; i++)
		{
			...
			// Upload the cube color.
			shader_uniform_vec3(light_cube_shader, "u_lightcolor", pointlight_colors[i]);
