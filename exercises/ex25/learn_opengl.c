...
main(int argc, char* argv[])
{
	...
	struct opengl_texture cube_emission_map = texture_create("assets/images/emission_map_woodbars.png");
	...
	while (!glfwWindowShouldClose(window.handle))
	{
		...
		texture_bind(cube_emission_map, 2);
		...
		shader_uniform_int(cube_shader, "material.emission", 2);
