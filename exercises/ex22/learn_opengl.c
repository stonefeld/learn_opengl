...
main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window.handle))
	{
		...
		shader_uniform_vec3(lighting_shader, "light.ambient", (vec3){ 1.0f, 1.0f, 1.0f });
		shader_uniform_vec3(lighting_shader, "light.diffuse", (vec3){ 1.0f, 1.0f, 1.0f });
		shader_uniform_vec3(lighting_shader, "light.specular", (vec3){ 1.0f, 1.0f, 1.0f });

		// Material lighting uniforms.
		shader_uniform_vec3(lighting_shader, "material.ambient", (vec3){ 0.24725f, 0.1995f, 0.0745f });
		shader_uniform_vec3(lighting_shader, "material.diffuse", (vec3){ 0.75164f, 0.60648f, 0.22648f });
		shader_uniform_vec3(lighting_shader, "material.specular", (vec3){ 0.628281f, 0.555802f, 0.366065f });
		shader_uniform_float(lighting_shader, "material.shininess", 40.0f);
